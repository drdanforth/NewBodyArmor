...
$file_name = 'BAiPhone-CT.php'; //<-- if raname this file you must give the name of the file here.
...
if($_GET['SERIES']){
	...
	if ($arraycount > 0){
		...
		if($return == 'RESULTS'){
			...
			echo "&nbsp;&nbsp;&nbsp;&nbsp;<font color='#aa1e21' face='Arial' style='font-size:16px;'><br /><br /><br /><br /><ul><li><div align='center'><b>Pick a ". ucfirst(strtolower($thisquery[0])) .":<br /></b></font> <select style='width:5em;' name='$thisquery[0]' onchange='document.my_form.submit();'><option name='blank' value='blank'>&nbsp;</option>";
			foreach($content as $make){
	...
	echo "</select></div></li></ul>";
	echo "&nbsp;&nbsp;&nbsp;&nbsp;<a style='color:#000000; font-family:Arial; font-size:16px;' href='$file_name'><b>$theYear</b></a> / <a style='color:#000000; font-family:Arial; font-size:16px;' href='$file_name?year=$theYear'><b> $themakename[1]</b></a><input type='hidden' name='year' id='year' value='$theYear' ><input type='hidden' name='make' id='make' value='$_GET[make]' > / <br />";
	echo "<p align='center'>&#8226;&nbsp;Tap Body Armor logo to start over</p>";
...
echo "<br /><br /><br /><br /><ul><li><div align='center'><font color='#aa1e21' face='Arial' style='font-size:16px;'><b>Select a Year:<br /></b></font></div> <div align='center'><select style='width:5em;' name='year' id='year' onchange='document.my_form.submit();'><option name='blank' value='blank'>&nbsp;</option>";
$eYear = $eYear + 1;
