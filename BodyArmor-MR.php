...
if (isset($_GET['series'])) {
    ...
    $xml = getXML(2, $theYear, $themake, $themodel, $thesubmodel, $theseries);
    ...
    $xml = getXML(2, $theYear, $themake, $themodel, $thesubmodel);
    $dropdownData = xmlGetDropdownData($xml);
    ...
    $xml = getXML(2, $theYear, $themake, $themodel);
    $dropdownData = xmlGetDropdownData($xml);
